function [sleeve_region_im, collar_region_im] = segment_upper_part_ROI(img_path)
    ...
    %figure, imshow( im(main_region.h_start:main_region.h_end,main_region.w_start:main_region.w_end,:) );
    sleeve_region_im = im(sleeve_region.h_start:sleeve_region.h_end,sleeve_region.w_start:sleeve_region.w_end,:);
    collar_region_im = im(collar_region.h_start:collar_region.h_end,collar_region.w_start:collar_region.w_end,:);
